...
### Objective
Analyze and visualize hotel booking data. Stakeholders want the following questions answered:
1. Is hotel revenue growing by year?
2. Should we increase the parking lot size?
3. What trends can we see in the data?

### Data set
- Hotel revenue data [Absent Data](https://absentdata.com/data-analysis/where-to-find-data/)
